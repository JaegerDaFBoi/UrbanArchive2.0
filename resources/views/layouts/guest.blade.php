            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-menu-item">
                        <a class="nav-link nav-menu-link" aria-current="page" href="{{ url('/dashboard') }}">Inicio</a>
                    </li>
                    <li class="nav-menu-item">
                        <a class="nav-link nav-menu-link" aria-current="page" href="#">Categorias</a>
                    </li>
                    <li class="nav-menu-item">
                        <a class="nav-link nav-menu-link" aria-current="page" href="{{ route('login') }}">Ingresar</a>
                    </li>
                    <li class="nav-menu-item">
